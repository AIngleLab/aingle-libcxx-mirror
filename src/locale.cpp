...
extern "C" void aingle_assert( unsigned int test, const char* msg  );
size_t strftime(char*, size_t, const char*, const struct tm*) { aingle_assert(false, "error: strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { aingle_assert(false, "error: strftime_l called"); }
